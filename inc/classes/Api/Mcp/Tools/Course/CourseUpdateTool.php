...
/**
 * Class CourseUpdateTool
 * 更新既有課程
 */
final class CourseUpdateTool extends AbstractTool {
	...
	public function get_description(): string {
		return __(
			'更新既有課程的欄位（名稱、狀態、價格、描述、限制等）。未傳入的欄位不會被覆寫。',
			'power-course'
		);
	}
		...
		return [
			...
			'properties' => [
				'id'                => [
					'type'        => 'integer',
					'minimum'     => 1,
					'description' => __( '要更新的課程 ID', 'power-course' ),
				],
				'name'              => [
					'type'        => 'string',
					'minLength'   => 1,
				...
				'regular_price'     => [
					'type'        => 'string',
					'description' => __( '原價', 'power-course' ),
				],
				'sale_price'        => [
					'type'        => 'string',
	...
	public function get_output_schema(): array {
		return [
			...
			'properties' => [
				'id' => [
					'type'        => 'integer',
					'description' => __( '被更新的課程 ID', 'power-course' ),
				],
			],
		];
	}
