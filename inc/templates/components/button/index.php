...
$default_props = [
	...
	'children'      => '按鈕',
	'icon'          => '',
	'icon_class'    => ' h-4 w-4 group-hover:fill-white transition-fill duration-300 ',
...
$icon_html = $loading ? '<span class="loading loading-spinner text-primary group-hover:text-white transition duration-300"></span>' : Templates::safe_get(
	"icon/{$icon}",
	[
		'class' => 'h-4 w-4 group-hover:fill-white transition-fill duration-300',
	],
	false
);
