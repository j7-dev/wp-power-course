...
printf(
	/*html*/'
<div id="pc-classroom-header" class="w-full bg-white py-4 px-4 lg:px-6 flex flex-col lg:flex-row justify-between lg:items-center top-0 z-30" style="position:fixed;">
