...
│       ├── components/
│       │   ├── chapters/             # 章節元件 (Edit.tsx)
│       │   ├── course/               # 課程相關元件
│       │   ├── emails/               # Email 模板元件
│       │   ├── formItem/             # 表單項目元件
│       │   ├── general/              # 通用元件 (PageLoading 等)
│       │   ├── layout/               # 版面元件 (ThemedLayoutV2)
│       │   ├── post/                 # 文章相關元件
│       │   ├── product/              # 商品相關元件
│       │   └── user/                 # 用戶相關元件
│       ├── hooks/
│       │   ├── index.tsx             # hooks 匯出
│       │   ├── useCourseSelect.tsx   # 課程選擇 Select hook
│       │   ├── useEditorDrawer.tsx   # 編輯器抽屜 hook
│       │   ├── useEnv.tsx            # 環境變數 hook（解密）
│       │   ├── useGCDItems.tsx       # GCD items hook
│       │   ├── useProductSelect.tsx  # 商品選擇 hook
│       │   └── useUserFormDrawer.tsx # 用戶表單抽屜 hook
│       ├── pages/admin/
│       │   ├── Analytics/            # 營收分析頁
│       │   ├── BunnyMediaLibraryPage/ # Bunny CDN 媒體庫
│       │   ├── Courses/
│       │   │   ├── List/             # 課程列表 (ProTable)
│       │   │   └── Edit/             # 課程編輯（多分頁）
│       │   │       └── tabs/
│       │   │           ├── CourseAnalysis/
│       │   │           ├── CourseAnnouncement/
│       │   │           ├── CourseBundles/    # 銷售方案管理
│       │   │           ├── CourseDescription/
│       │   │           ├── CourseOther/      # 顯示設定/浮水印
│       │   │           ├── CoursePrice/      # 定價/訂閱設定
│       │   │           ├── CourseQA/         # Q&A 管理
│       │   │           └── CourseStudents/   # 學員管理
│       │   ├── Emails/
│       │   │   ├── List/             # Email 模板列表
│       │   │   └── Edit/             # 拖拉式 Email 編輯器
│       │   ├── MediaLibraryPage/     # WordPress 媒體庫
│       │   ├── Products/             # 課程權限綁定
│       │   ├── Settings/             # 外掛設定
│       │   ├── Shortcodes/           # Shortcode 參考
│       │   ├── Students/             # 學員管理
│       │   └── Teachers/             # 講師管理
│       ├── resources/
